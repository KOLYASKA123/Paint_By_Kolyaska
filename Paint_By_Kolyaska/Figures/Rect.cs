...
namespace Paint_By_Kolyaska
{
    ...
    public class Rect : Figure
    {
        ...
        public Rect(int x1, int y1, int x2, int y2, Color outlineColor, Color fillColor, int outlineWidth, bool fillFlag) :
            base(x1, y1, x2, y2, outlineColor, fillColor, outlineWidth, fillFlag)
        { }

        /// <summary>
        /// Выполняет финальную отрисовку прямоугольника.
        /// </summary>
        ...
        /// <summary>
        /// Выполняет промежуточную отрисоку контура прямоугольника.
        /// </summary>
        /// <param name="g">Какой-то объект, необходимый для рисования графических примитивов.</param>
        ...
        public override void Move(Graphics g, int dx, int dy)
        {
            ...
            if (fillFlag) g.FillRectangle(new SolidBrush(fillColor),
